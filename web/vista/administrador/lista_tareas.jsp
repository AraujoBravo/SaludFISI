                            ...
                            <div class="page-header float-right">
                                <div class="page-title">
                                    <ol class="breadcrumb text-right">
                                        ...
                                        <li class="active">Todas las tareas</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                                    ...
                                    <table class="table text-center">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-info" data-toggle="modal" data-target="#estadoUno" <% if(tarea.getEstado().equals(Task.estados[0]) || tarea.getEstado().equals(Task.estados[2])) { %>disabled <%}%> >Finalizado</button>
                                                </td>
                                                <td >
