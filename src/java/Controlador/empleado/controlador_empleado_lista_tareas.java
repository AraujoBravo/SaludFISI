 ...
 * @author JuanEAB
 */
@WebServlet(name = "controlador_empleado_lista_tareas", urlPatterns = {"/controlador_empleado_lista_tareas"})
public class controlador_empleado_lista_tareas extends HttpServlet {
