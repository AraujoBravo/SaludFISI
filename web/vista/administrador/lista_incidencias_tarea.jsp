                            ...
                            <div class="page-header float-right">
                                <div class="page-title">
                                    <ol class="breadcrumb text-right">
                                        ...
                                        <li class="active">Incidencias de Tareas</li>
                                    </ol>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong class="card-title">Incidencias de Tareas</strong>
                                </div>
                                    ...
                                    <table class="table text-center">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-info" data-toggle="modal" data-target="#estadoUno">Completado</button>
                                                </td>
                                                <td >
