...
<html>
                ...
                <div class="animated fadeIn">
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <h2>Vista Maestro: Jhon Trujillo</h2>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 col-lg-12">
                            <div class="card">
                                <div class="card-body">
                                    <form action="/Observer/CargarVistaMaestro" method="post"/>
                                    <div class="row">
                                        <div class="col-md-6">
                                            <h5>Mandar mensaje a alumnos: </h5>
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <label>Nombres: </label>
                                            <input type="text" placeholder="ingresar nombre" name="nombre_alumno"/>
                                            <br>
                                            <label>Password</label>
                                            <input type="password" placeholder="ingresar password" name="password"/>
                                            <input type="text" id="time_alumno" name="time_alumno" style="display: none"/>
                                            <br>
    ...
    <script type="text/javascript">
        function startTime() {
            ...
            document.getElementById('time').value = d + "/" + m + "/" + y + " - " + h + ":" + m + ":" + s;
            document.getElementById('time_alumno').value = d + "/" + m + "/" + y + " - " + h + ":" + m + ":" + s;
