<%-- 
    Document   : lista_tareas
    Created on : 10/12/2019, 04:13:21 AM
    Author     : JuanEAB
--%>
<%@page import="com.mycompany.models.Task"%>
...
<%
    ...
    List<Task> lista_tareas = (List<Task>) request.getAttribute("lista_tareas");
%>
                        ...
                        <div class="col-lg-12">
                            <div class="card">
                                <div class="card-header">
                                    <strong class="card-title">Todas las tareas</strong>
                                </div>
                                <div class="table-stats order-table ov-h">
                                    <table class="table text-center">
                                        ...
                                        <tbody>
                                            <% if (!lista_tareas.isEmpty()) {
                                                    int i = 0;
                                                    for (Task tarea : lista_tareas) {
                                                        i++;%>
                                            <tr>
                                                <td><%=i%></td>
                                                <td><%=tarea.getIdTask()%></td>
                                                <td><%=tarea.getTitleTask()%></td>
                                                <td><%=tarea.getNombre()%></td>
                                                <td><%=tarea.getDate_start()%></td>
                                                <td><%=tarea.getDate_end()%></td>
                                                <td>
                                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModalUno">Ver Más</button>
                                                </td>
                                                <td>
                                                    <button type="button" class="btn btn-info" data-toggle="modal" data-target="#estadoUno" <% if (tarea.getEstado().equals(Task.estados[1]) || tarea.getEstado().equals(Task.estados[2])) { %>disabled <%}%> >Realizado</button>
                                                </td>
                                                <td >
                                                    <span class="badge badge-complete"><%=tarea.getEstado()%></span>
                                                </td>
                                            </tr>
                                            <% }
                                                }%>
                                            ...
                                            <tr>
                                                ...
                                                <td> #5466 </td>
                                                <td>  <span class="name">Título 1</span> </td>
                                                <td> <span class="product">45</span> </td>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-info" data-toggle="modal" data-target="#estadoDos">Completado</button>
                                                </td>
                                                <td>
                                    ...
                                    <div class="modal fade" id="estadoUno" role="dialog">
                                        <div class="modal-dialog">
                                            <!-- Modal content-->
                                            <form action="/ProyectoPatrones/controlador_empleado_lista_tareas" method="post">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                                                    ...
                                                    <div class="modal-body">
                                                        ¿Desea dar por "Realizado" la tarea?
                                                    </div>
                                                    <div class="modal-footer">
